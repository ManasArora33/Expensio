...
import { DollarSign, ArrowRight, UserPlus, Check } from 'lucide-react';
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response) {
                ...
                navigate('/expenses'); // Navigate after successful registration
            }
        } catch (error) {
    ...
    return (
        <div className="h-screen bg-gradient-to-br from-blue-50 to-white flex items-start justify-center overflow-y-auto">
            <div className="max-w-md w-full bg-white p-6 sm:p-8 rounded-2xl shadow-xl my-auto mx-4 sm:mx-6">
                <div className="text-center mb-6">
                    <div className="flex justify-center mb-3">
                        <DollarSign className="h-10 w-10 text-blue-600" />
                    </div>
                    <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900">
                        Create your <span className="bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">Expensio</span> account
                    </h2>
